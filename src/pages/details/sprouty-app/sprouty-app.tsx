            ...
            <DetailsFrame>
              <DetailsFrame.Container>
                ...
                <DetailsFrame.Container.Text>
                  ...
                  детей до года. У приложения есть бесплатная версия и расширенная версия по подписке.
                  Подписка дает пользователям более персонализированный опыт, например, комплексы упражнений
                  на каждый день.
                </DetailsFrame.Container.Text>
              </DetailsFrame.Container>
              ...
              <DetailsFrame.Container end>
                ...
                <DetailsFrame.Container.Text margin>
                  Я занималась доработкой существующего функционала приложения и добавлений новых функций.
              ...
              <DetailsFrame.Container>
                ...
                <DetailsFrame.Container.Text margin>
                  Я проанализировала аналогичные сервисы, которые закрывали потребности нашей аудитории
                  (прямых конкурентов). Затем выделила косвенных конкурентов, которые предлагали схожие
                  решения. Таким образом я хотела понять:
                </DetailsFrame.Container.Text>
                <DetailsFrame.Container.List
                  list={[
